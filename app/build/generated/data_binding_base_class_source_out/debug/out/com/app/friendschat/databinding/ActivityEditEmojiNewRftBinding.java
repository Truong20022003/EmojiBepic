...
public abstract class ActivityEditEmojiNewRftBinding extends ViewDataBinding {
  @NonNull
  ...
  protected ActivityEditEmojiNewRftBinding(Object _bindingComponent, View _root,
      int _localFieldCount, ImageView ivBack, ImageView ivDeleteEmoji, ImageView ivFlipHorizontal,
  ...
  @NonNull
  public static ActivityEditEmojiNewRftBinding inflate(@NonNull LayoutInflater inflater,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_edit_emoji_new_rft, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static ActivityEditEmojiNewRftBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<ActivityEditEmojiNewRftBinding>inflateInternal(inflater, R.layout.activity_edit_emoji_new_rft, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_edit_emoji_new_rft, null, false, component)
   */
  @NonNull
  @Deprecated
  public static ActivityEditEmojiNewRftBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<ActivityEditEmojiNewRftBinding>inflateInternal(inflater, R.layout.activity_edit_emoji_new_rft, null, false, component);
  }

  public static ActivityEditEmojiNewRftBinding bind(@NonNull View view) {
  ...
  public static ActivityEditEmojiNewRftBinding bind(@NonNull View view,
      @Nullable Object component) {
    return (ActivityEditEmojiNewRftBinding)bind(component, view, R.layout.activity_edit_emoji_new_rft);
  }
}
