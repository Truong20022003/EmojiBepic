...
public abstract class ActivityEmojiBepicNewRftBinding extends ViewDataBinding {
  @NonNull
  ...
  protected ActivityEmojiBepicNewRftBinding(Object _bindingComponent, View _root,
      int _localFieldCount, Guideline g1, ImageView ivBack, ImageView ivDeleteEmoji,
      ImageView ivFlipHorizontal, ImageView ivFlipVertical, ImageView ivLockEmoji, ImageView ivMore,
      ImageView ivOption, ImageView ivRefresh, RelativeLayout llOptions, RelativeLayout rlDelete,
  ...
  @NonNull
  public static ActivityEmojiBepicNewRftBinding inflate(@NonNull LayoutInflater inflater,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_emoji_bepic_new_rft, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static ActivityEmojiBepicNewRftBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<ActivityEmojiBepicNewRftBinding>inflateInternal(inflater, R.layout.activity_emoji_bepic_new_rft, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_emoji_bepic_new_rft, null, false, component)
   */
  @NonNull
  @Deprecated
  public static ActivityEmojiBepicNewRftBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<ActivityEmojiBepicNewRftBinding>inflateInternal(inflater, R.layout.activity_emoji_bepic_new_rft, null, false, component);
  }

  public static ActivityEmojiBepicNewRftBinding bind(@NonNull View view) {
  ...
  public static ActivityEmojiBepicNewRftBinding bind(@NonNull View view,
      @Nullable Object component) {
    return (ActivityEmojiBepicNewRftBinding)bind(component, view, R.layout.activity_emoji_bepic_new_rft);
  }
}
