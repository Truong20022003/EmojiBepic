...
import com.app.friendschat.databinding.FragmentCreatedDraftBepicRftBinding
import com.app.friendschat.ui.base.BaseFragment
import com.app.friendschat.utils.EventTracking

class CreatedDraftBepicFragmentRft :
    BaseFragment<CreatedDraftViewModel, FragmentCreatedDraftBepicRftBinding>() {
    ...
    override fun getResourceLayout(): Int = R.layout.fragment_created_draft_bepic_rft
}