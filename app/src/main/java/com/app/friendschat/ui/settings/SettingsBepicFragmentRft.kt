...
import com.app.friendschat.databinding.FragmentSettingsBepicRftBinding
...
import com.app.friendschat.ui.language_setting.LanguageBepicActivityRft
import com.app.friendschat.ui.policy.PolicyBepicActivityRft
...
class SettingsBepicFragmentRft : BaseFragment<SettingsViewModel, FragmentSettingsBepicRftBinding>() {
    ...
    override fun initView() {
        ...
        binding.llLanguage.tapAndCheckInternet {
            showActivity(LanguageBepicActivityRft::class.java)
        ...
        binding.llPrivacyPolicy.tapAndCheckInternet {
            showActivity(PolicyBepicActivityRft::class.java)
    ...
    override fun getResourceLayout(): Int = R.layout.fragment_settings_bepic_rft
