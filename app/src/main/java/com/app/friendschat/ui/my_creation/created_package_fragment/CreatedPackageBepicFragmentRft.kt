...
import com.app.friendschat.databinding.FragmentCreatedPackageBepicRftBinding
...
class CreatedPackageBepicFragmentRft: AddToWhatsappBepicFragment<CreatedPackageViewModel, FragmentCreatedPackageBepicRftBinding>() {
    ...
    override fun getResourceLayout(): Int = R.layout.fragment_created_package_bepic_rft
}